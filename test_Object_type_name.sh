...
riscv64-elf-gcc -mabi=ilp32 -march=rv32imzicsr -nostdlib -o a.out cc-rv-rt.o test_Object_type_name.c -T cc-rv-rt.ld
spike --isa=RV32IMZICSR a.out > test_Object_type_name.out
