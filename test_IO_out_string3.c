...
extern void IO_out_string(IO*, String* x);
...
int main() {
    // testing that a string with the length equal to the syscall number does
    // not get the simulator to get stuck
    print_string("abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabc\n", 64);
