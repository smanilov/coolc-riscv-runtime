...
_string1.length:
    ...
    .word 4  # object size;     4 words (16 bytes); GC tag not included
    .word 0  # dispatch table;  Int has no methods
    .word 6  # first attribute; value of Int
...
_string2.content:
    ...
    .word 6  # object size;     6 words (16 + 8 bytes); GC tag not included
    .word String_dispTab
    .word _string2.length # first attribute; pointer length
    .string "world!" # includes terminating null char
    .byte 0
