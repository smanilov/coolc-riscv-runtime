...
riscv64-elf-gcc -mabi=ilp32 -march=rv32izicsr -nostdlib -o a.out cc-rv-rt.o test_Object_abort.c -T cc-rv-rt.ld
spike --isa=RV32IZICSR a.out > test_Object_abort.out
